/*
  # Fix Service Listings Column Names and Add Verified Filter

  1. Problem
    - Functions reference sl.average_rating but actual column is rating_average
    - Functions reference sl.total_bookings but actual column is booking_count
    - Functions reference sl.image_url but actual column is featured_image_url

  2. Changes
    - Fix all column name references to match actual schema
    - Add p_verified parameter for filtering by verification status
    - Maintain backward compatibility in return type

  3. Verification Logic
    - p_verified = true: Only verified providers/customers
    - p_verified = false/NULL: No verification filtering
*/

-- ============================================================================
-- STEP 1: Fix get_services_cursor_paginated with correct column names
-- ============================================================================
...
-- ============================================================================
-- STEP 2: Fix get_jobs_cursor_paginated with verified filter
-- ============================================================================
