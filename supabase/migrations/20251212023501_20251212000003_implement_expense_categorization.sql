...
CREATE INDEX IF NOT EXISTS idx_expense_tags_user ON expense_tags(user_id);
CREATE INDEX IF NOT EXISTS idx_expense_mappings_service ON expense_category_mappings(service_category_id);
CREATE INDEX IF NOT EXISTS idx_categorization_rules_user ON expense_categorization_rules(user_id, is_active);
CREATE INDEX IF NOT EXISTS idx_booking_categorizations_booking ON booking_expense_categorizations(booking_id);
CREATE INDEX IF NOT EXISTS idx_booking_categorizations_category ON booking_expense_categorizations(expense_category_id);
CREATE INDEX IF NOT EXISTS idx_booking_tags_booking ON booking_expense_tags(booking_id);
CREATE INDEX IF NOT EXISTS idx_booking_tags_tag ON booking_expense_tags(tag_id);
