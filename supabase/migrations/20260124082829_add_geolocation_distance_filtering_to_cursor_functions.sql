/*
  # Add Geolocation Distance Filtering to Cursor Functions

  1. Purpose
    - Enable location-based filtering by distance radius
    - Support distance-based sorting
    - Maintain backward compatibility (NULL params = no filtering)

  2. Changes
    - Add p_user_lat, p_user_lng, p_distance parameters
    - Add distance calculation using earth_distance
    - Filter results by distance radius when provided
    - Support distance sorting

  3. Notes
    - Uses earth_distance extension for accurate geo calculations
    - Distance in miles
    - NULL geo params = no geo filtering
*/

-- ============================================================================
-- STEP 1: Ensure earth_distance extension is available
-- ============================================================================

CREATE EXTENSION IF NOT EXISTS earthdistance CASCADE;

-- ============================================================================
-- STEP 2: Update get_services_cursor_paginated with geo filtering
-- ============================================================================
...
-- ============================================================================
-- STEP 3: Update get_jobs_cursor_paginated with geo filtering
-- ============================================================================

DROP FUNCTION IF EXISTS get_jobs_cursor_paginated(
  TIMESTAMPTZ, UUID, INT, UUID, TEXT, DECIMAL, DECIMAL, TEXT, BOOLEAN
);
