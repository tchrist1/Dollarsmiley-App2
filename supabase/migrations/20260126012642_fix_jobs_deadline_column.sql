/*
  # Fix Jobs Function - Remove Non-Existent deadline Column

  ## Issue
  - jobs table has execution_date_start/execution_date_end, not deadline
  - Function references j.deadline causing error 42703

  ## Solution
  - Remove deadline from SELECT (not needed by client)
  - Client uses execution_date_start/execution_date_end instead
*/
