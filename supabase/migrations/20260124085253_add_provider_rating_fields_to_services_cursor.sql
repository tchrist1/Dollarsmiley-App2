/*
  # Add Provider Rating Fields to Services Cursor

  1. Problem
    - UI expects profile.rating_average and profile.rating_count
    - RPC only returns listing ratings, not provider ratings
    - Missing fields cause profile section to not render properly

  2. Solution
    - Add p.rating_average as provider_rating_average
    - Add p.rating_count as provider_rating_count
    - Ensures profile cards display correctly with ratings
*/
