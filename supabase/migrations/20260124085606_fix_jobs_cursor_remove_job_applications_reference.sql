/*
  # Fix Jobs Cursor - Remove job_applications Reference

  1. Problem
    - Function references job_applications table which doesn't exist
    - Sorting by popular fails

  2. Solution
    - Remove popular sorting option for jobs
    - Keep distance, price_low, price_high sorting
*/
