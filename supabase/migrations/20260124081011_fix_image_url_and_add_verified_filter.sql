/*
  # Fix image_url Column Name and Add Verified Filter

  1. Problem
    - Previous migrations used sl.image_url which doesn't exist
    - Actual column is sl.featured_image_url
    - This broke all cursor queries

  2. Changes
    - Fix column reference from image_url to featured_image_url
...
-- ============================================================================
-- STEP 1: Fix get_services_cursor_paginated
-- ============================================================================
...
-- ============================================================================
-- STEP 2: Fix get_jobs_cursor_paginated
-- ============================================================================
