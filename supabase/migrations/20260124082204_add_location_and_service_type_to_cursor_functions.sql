/*
  # Add Location and Service Type to Cursor Functions

  1. Problem
    - Cursor functions don't return p.location field
    - Cursor functions don't return sl.service_type field
    - This causes "location not set" to display on all listings

  2. Changes
    - Add provider_location to return columns
    - Add service_type to return columns
    - Both functions updated for consistency

  3. Impact
    - Listings will now correctly display provider locations
    - Service type will determine how location is displayed
*/

-- ============================================================================
-- STEP 1: Update get_services_cursor_paginated
-- ============================================================================
...
-- ============================================================================
-- STEP 2: Update get_jobs_cursor_paginated
-- ============================================================================
