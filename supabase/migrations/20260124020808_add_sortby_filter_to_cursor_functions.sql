/*
  # Add Sort By Filter to Cursor Functions

  1. Purpose
    - Connect Sort By UI filter to backend queries
    - Enable dynamic ordering based on user selection
    - Maintain cursor pagination efficiency

  2. Changes
    - Add p_sort_by parameter to get_services_cursor_paginated
    - Add p_sort_by parameter to get_jobs_cursor_paginated
    - Implement dynamic ORDER BY based on sort selection
    - Preserve cursor pagination on created_at

  3. Sort Options
    - relevance: Default (created_at DESC)
    - price_low: Price ascending
    - price_high: Price descending
    - rating: Rating descending (services only)
    - popular: Total bookings descending
    - recent: Created date descending
    - distance: Reserved for future implementation

  4. Strategy
    - Primary sort: User-selected field
    - Secondary sort: created_at DESC (for cursor consistency)
    - Tertiary sort: id DESC (for tie-breaking)
*/

-- ============================================================================
-- STEP 1: Drop old function and recreate with sort_by parameter
-- ============================================================================
...
-- ============================================================================
-- STEP 2: Drop old function and recreate with sort_by parameter
-- ============================================================================
