/*
  # Fix Jobs Cursor - Use Correct Column Names

  1. Problem
    - Function references j.deadline which doesn't exist
    - Jobs table uses execution_date_start, execution_date_end, expires_at

  2. Solution
    - Remove deadline from return table
    - Add execution_date_start, execution_date_end, expires_at
    - Match actual jobs table schema
*/
