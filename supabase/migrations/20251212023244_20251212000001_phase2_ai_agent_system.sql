...
CREATE INDEX IF NOT EXISTS idx_ai_agent_actions_type ON ai_agent_actions(action_type);
CREATE INDEX IF NOT EXISTS idx_ai_agent_actions_created ON ai_agent_actions(created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_ai_recommendations_accepted ON ai_recommendations(is_accepted) WHERE is_accepted IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_ai_moderation_content ON ai_content_moderation(content_id, content_type);
CREATE INDEX IF NOT EXISTS idx_ai_moderation_result ON ai_content_moderation(moderation_result);
CREATE INDEX IF NOT EXISTS idx_ai_moderation_human_reviewed ON ai_content_moderation(human_reviewed);
CREATE INDEX IF NOT EXISTS idx_ai_moderation_created ON ai_content_moderation(created_at DESC);
